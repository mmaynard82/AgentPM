...
if api_key:
    ...
    # Your Streamlit app logic that uses the Gemini API
    st.title("My Gemini-powered App")
    ...
    st.error("Gemini API key not found. Please set it in Streamlit secrets (for cloud) or a .env file (for local development).")
